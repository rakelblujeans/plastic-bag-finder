...
angular.module('starter.services').service('UserService', ['Auth', '$firebaseArray', '$cordovaOauth', 'googleAuthKey', function (Auth, $firebaseArray, $cordovaOauth, googleAuthKey) {
  ...
  var login = function login() {
    if (ionic.Platform.isWebView()) {
      $cordovaOauth.google(googleAuthKey, ["email"]).then(function (response) {
  ...
  var _firebaseSigninWithCredential = function _firebaseSigninWithCredential(token) {
  ...
  var _firebaseSigninWithRedirect = function _firebaseSigninWithRedirect() {
