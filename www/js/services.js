...
angular.module('starter.services', []).constant('googleMapsKey', 'AIzaSyAqdnKiE3Z48MosGNE015UlO4kjg23dKf4').factory('PinService', function ($firebaseArray) {
  ...
  // todo
  var favorite = function favorite(pin) {
    pin.favorite = true;
    _save(pin);
  };

  // todo
  var unfavorite = function unfavorite(pin) {
    pin.favorite = false;
    _save(pin);
  };
